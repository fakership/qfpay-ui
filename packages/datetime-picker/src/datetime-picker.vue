...
<script type="text/babel">
  import picker from 'qfpay-ui/packages/picker/index.js';
  import popup from 'qfpay-ui/packages/popup/index.js';
  if (process.env.NODE_ENV === 'component') {
    require('qfpay-ui/packages/picker/style.css');
    require('qfpay-ui/packages/popup/style.css');
  }
